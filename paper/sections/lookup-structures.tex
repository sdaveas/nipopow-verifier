...
$\pic$. In this context, we consider the predicate $\pred$ to be "does block
$\boi$ exists inside proof $\pr$?", where $\boi$ denotes the block of interest
of proof $\pr$. The entity that initiates a submission is $\es$, and the entity
