...
into the NIPoPoW client, and we analyze the performance in comparison with the
...
\begin{figure*}[h]
    ...
    \caption{The \emph{hash-and-resubmit} pattern. First, an invoker calls
        ...
        blockchain as the digest of a hash function \textsf{H}($\data$). Then,
        ...
        $\datas$, where $\datas$$\neq$$\data$. Finally, the node invokes
