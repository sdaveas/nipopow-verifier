...
contract-opt-3}, several patterns have been proposed. Towards eliminating
...
~\cite{contract-opt-4} proposes an efficient manner to replace read storage
...
Ranges ~\cite{mmr}. In this variation of the pattern, which we term
...
In \emph{submit} phase, a \emph{proof} is submitted, which, in the case of
