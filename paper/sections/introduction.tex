...
amount of resources since they growth linearly to the size of the blockchain.
In Ethereum, for instance, headers sum up to approximately 5.1
...
events inside a blockchain. These proofs require only polylogarithmic size of
...
include build-in NIPoPoWs support. ERGO~\cite{ergo}, Nimiq~\cite{nimiq}, and
