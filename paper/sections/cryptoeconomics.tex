...
Figure~\ref{fig:cryptoeconomics}. The horizontal axis shows the collateral denominated in
...
\vspace*{-3mm}
    \begin{center}
        \includegraphics[width=0.8\columnwidth]{figures/collateral-contest.pdf}
    \end{center}
...
We conclude that consumption of cross-chain data within the Ethereum blockchain can
