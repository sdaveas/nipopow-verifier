...
injected a function in Geth's \texttt{miner} object be inly invoked when a new
...
\paragraph {Configuration:} We observed that using an EVM alone is not trivial.
The set of configurations we used for each EVM can be found in our public
repository(ref). We hope this will facilitate future work.
...
\paragraph{Position of block of interest}
